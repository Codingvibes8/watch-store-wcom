...
import toast from "react-hot-toast";
  ...
  /**
   * Fetches and displays all orders of the logged-in user.
   *
   * It uses the IntersectionObserver API to fetch more orders when the user scrolls to the bottom of the list.
   *
